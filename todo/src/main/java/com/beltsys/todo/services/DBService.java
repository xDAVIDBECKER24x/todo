package com.beltsys.todo.services;
...
import com.beltsys.todo.domain.Todo;
import com.beltsys.todo.repositories.TodoRepository;
...
public class DBService {
	...
	public void instanciaBaseDeDados() throws ParseException {
		...
		Todo t1 = new Todo(null, "Combar de Akali", "Estudar Spring Boot 2 e Angular 11", sdf.parse("25/03/2022"), false);
